...
function runBubbleSortTests() {
    console.log("\n--- Running Bubble Sort Tests ---");

    // Test Case 1: Empty array
    let arr1 = [];
    console.assert(isSorted(bubbleSort(arr1.slice())), "Test 1 Failed: Empty array");
    console.assert(arr1.length === 0, "Test 1 Failed: Empty array length");

    // Test Case 2: Single element array
    let arr2 = [5];
    console.assert(isSorted(bubbleSort(arr2.slice())), "Test 2 Failed: Single element array");
    console.assert(arr2[0] === 5, "Test 2 Failed: Single element value");

    // Test Case 3: Already sorted array
    let arr3 = [1, 2, 3, 4, 5];
    let sortedArr3 = bubbleSort(arr3.slice());
    ...
    let arr4 = [5, 4, 3, 2, 1];
    let sortedArr4 = bubbleSort(arr4.slice());
    ...
    let sortedArr5 = bubbleSort(arr5.slice());
    ...
    let sortedArr6 = bubbleSort(arr6.slice());
    ...
    let sortedArr7 = bubbleSort(arr7.slice());
    ...
    const randomArr1 = generateRandomArray(100, -50, 50);
    const sortedRandomArr1 = bubbleSort([...randomArr1]); // Pass a copy
    ...
    let arr9 = [7, 7, 7, 7, 7];
    let sortedArr9 = bubbleSort(arr9.slice());
...
module.exports = runBubbleSortTests;